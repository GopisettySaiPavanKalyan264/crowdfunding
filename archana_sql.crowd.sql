...
quarter(from_unixtime(Created_at)) AS quarter from projects
...
SELECT (round(AVG(DATEDIFF(FROM_UNIXTIME(created_at),FROM_UNIXTIME(successful_at))),2)) AS Average_Days
FROM projects
